...
export default {
  nomenclaturesUri: {
    ...
    getByIdUri: `${backendBase}/api/nomenclatures/<%accessToken%>?access_token=<%accessToken%>`,
    getByIdWFilterUri: `${backendBase}/api/nomenclatures/<%accessToken%>?access_token=<%accessToken%>&filter={"include":["accepted","basionym","replaced","nomenNovum",{"genusRel":["family","familyApg"]}]}`,
    getNomenclatoricSynonymsUri: `${backendBase}/api/nomenclatures/<%accessToken%>/synonymsNomenclatoric?access_token=<%accessToken%>&filter={"include":"synonymsNomenclatoric"}`,
    getTaxonomicSynonymsUri: `${backendBase}/api/nomenclatures/<%accessToken%>/synonymsTaxonomic?access_token=<%accessToken%>&filter={"include":"synonymsNomenclatoric"}`,
    getInvalidSynonymsUri: `${backendBase}/api/nomenclatures/<%accessToken%>/synonymsInvalid?access_token=<%accessToken%>`,
    getSynonymsOfParent: `${backendBase}/api/nomenclatures/<%accessToken%>/parentOfSynonyms?access_token=<%accessToken%>`,
    getBasionymForUri: `${backendBase}/api/nomenclatures/<%accessToken%>/basionymFor?access_token=<%accessToken%>`,
    getReplacedForUri: `${backendBase}/api/nomenclatures/<%accessToken%>/replacedFor?access_token=<%accessToken%>`,
    getNomenNovumForUri: `${backendBase}/api/nomenclatures/<%accessToken%>/nomenNovumFor?access_token=<%accessToken%>`,
  ...
  generaUri: {
    ...
    getByIdWithFamilies: `${backendBase}/api/genera/<%accessToken%>?access_token=<%accessToken%>&filter={"include":["familyApg","family"]}`,
