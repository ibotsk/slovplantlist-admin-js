...
export default {
  nomenclaturesUri: {
    ...
    getNomenclatoricSynonymsUri: `${backendBase}/api/nomenclatures/<%id%>/synonymsNomenclatoric?access_token=<%accessToken%>&filter={"include":"synonymsNomenclatoric"}`,
    getTaxonomicSynonymsUri: `${backendBase}/api/nomenclatures/<%id%>/synonymsTaxonomic?access_token=<%accessToken%>&filter={"include":"synonymsNomenclatoric"}`,
